...
export async function startCommand(configPath, logLevel) {
    const log = getLogger();
    try {
        ...
        // Sync Engine
        const syncEngine = new SyncEngine(bus, registry, analyzer, policy, debouncer, stateStore, metrics, config);
        // File Watcher
        ...
        syncEngine.indexManually().catch((err) => {
